...
public class Army1 : MonoBehaviour
{
    ...
    void Start()
    {
        GameObject temp = GameObject.Find("EnemyBase");
    ...
    void FindNextTarget()
    {
        int layerMask = 1 << 10;    //Bit shifting from layer 10
    ...
    void Attack()
    {
        if (attackCounter <= 0)
        {
            ...
            newBullet.GetComponent<ArmyBullet>().target = target;
